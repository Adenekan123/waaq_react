  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className="flex flex-col gap-4 h-[80vh] p-6 overflow-hidden overflow-y-auto">
        {state?.items && Array.isArray(state.items) && state?.items.length ? (
          ...
          <div className="flex flex-col gap-12 my-auto ">
            ...
            <div className="text-center">
              ...
              <CustomButton
                title="Shop Now"
                styles="shadow-2xl font-bold"
                gradient="from-green-400 to-green-600"
                whenClicked={gotoShop}
              />
            </div>
          </div>
        )}
      ...
      {state?.items.length ? (
        <div className="mt-auto border-t py-3 px-6 pt-6 text-center">
          ...
          <CustomButton
            ...
            loading={chackout.loading}
            whenClicked={() =>
              user?.user ? chackout.init() : setVisitor(true)
            }
          />
        </div>
      ) : null}
